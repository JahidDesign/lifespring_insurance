//AgentInsuranceDashboardManager
...
const AgentInsuranceDashboardManager = () => {
  const { role, isAgent } = useContext(AuthContext);
...
export default AgentInsuranceDashboardManager;
