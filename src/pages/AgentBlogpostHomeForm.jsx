...
const AgentBlogpostHomeForm = () => {
      ...
      html: `
        <div class="flex flex-col md:flex-row bg-white text-black rounded-lg overflow-hidden shadow-xl">
          ...
          <div class="p-6 md:w-1/2 text-left">
            ...
            <p class="mb-2"><strong>🏷️ Tags:</strong> ${formData.tags}</p>
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("https://insurances-lmy8.onrender.com/blogpostHome", newBlog);
      showSuccessAlert();
      setFormData({
        title: "",
        details: "",
      ...
      >
        ...
        <div className="md:col-span-2">
          ...
          <input
            type="text"
            name="tags"
            placeholder="insurance, health, travel"
            value={formData.tags}
            onChange={handleChange}
            className="w-full border border-gray-300 px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
          />
...
export default AgentBlogpostHomeForm;
